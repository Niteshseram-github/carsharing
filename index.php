  ...
  <body>
    ...
    <!--Forgot password form-->
      ...
      <form method="post" id="requestbookingform">
        <div class="modal" id="requestbookingModal" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-header">
                  <button class="close" data-dismiss="modal">
              ...
              <div class="modal-body">
                  ...
                  <div class="form-group">
                      <label for="pickup" >Pick up location(Optional)</label>
                      <input class="form-control" type="text" name="pickup" id="pickup" placeholder="Pickup Location" maxlength="50">
                  </div>
                  
              </div>
              <div class="modal-footer">
                  <input class="btn green" name="request" type="submit" value="Request">
                <button type="button" class="btn btn-default" data-dismiss="modal">
                  Cancel
                </button>
              </div>
      ...
      <form method="post" id="cancelbookingform">
        <div class="modal" id="cancelbookingModal" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-header">
                  <button class="close" data-dismiss="modal">
              ...
              <div class="modal-body">
                  ...
                  <!--Bokking message from PHP file-->
                  <div id="cancelbookingmessage"></div>
    ...
    <!-- Footer-->
      <div class="footer">
          <div class="container">
              <p>MiniProject Copyright &copy; <?php $today = date("Y"); echo $today?>.</p>
          </div>
      </div>
